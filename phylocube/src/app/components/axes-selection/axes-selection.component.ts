...
export class AxesSelectionComponent implements OnInit {
  ...
  taxonX = new FormControl('Papillomaviridae | Taxonomy ID: 151340', [Validators.required, Validators.minLength(5)]);

  taxonY = new FormControl('Papillomaviridae | Taxonomy ID: 151340', [Validators.required, Validators.minLength(5)]);
  filteredTaxonsY$: Observable<Taxon[]>;

  taxonZ = new FormControl('Papillomaviridae | Taxonomy ID: 151340', [Validators.required, Validators.minLength(5)]);
